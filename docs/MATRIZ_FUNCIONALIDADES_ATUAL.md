...
| Cenários parallax 2D/2.5D | CANDIDATO PRÉ-MERGE — 4B.2 APROVADA NO ESCOPO | 4A, 4B.1 e 4B.2 comprovadas em `docs/evidence/ETAPA_4B2_PREVIEW_OVERLAYS_2026-08-18.md`; commit técnico `638db729` | painel/inspetor, persistência, exportação, engines, benchmark e merge ainda pendentes |
