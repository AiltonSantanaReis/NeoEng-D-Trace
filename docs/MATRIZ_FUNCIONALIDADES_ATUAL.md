...
| Cobertura | PARCIAL / EM TRATAMENTO | Pacotes 1 a 3: 762 testes locais; 83,79% de linhas, 70,36% de branches, 80,55% combinada e zero módulos abaixo de 30% | metas globais de 90% linhas/85% branches não atingidas; faltam ao menos 722 linhas e 543 branches; Pacote 3 sem CI, integração e CI pós-merge pendentes |
