...
| Cobertura | PARCIAL / EM TRATAMENTO | Pacotes 1 a 4: 779 testes locais; 86,06% de linhas, 73,38% de branches, 83,00% combinada e zero módulos abaixo de 30% | metas globais de 90% linhas/85% branches não atingidas; faltam ao menos 459 linhas e 430 branches; Pacote 4 sem CI, integração e CI pós-merge pendentes |
