...
**Estado atual:** Etapas 11 a 14 permanecem encerradas nos escopos aprovados. A Etapa 3 integrou a paleta visual, busca, localização, teclado e acessibilidade; o candidato local pré-merge já contém 4A, 4B.1, 4B.2 e 4B.3 com evidências hashadas, enquanto 4B.4–4B.5 permanecem pendentes. A release oficial `v0.2.0` permanece publicada como snapshot anterior e não representa automaticamente o `main` atual.
...
| Cenários parallax 2D/2.5D | CANDIDATO PRÉ-MERGE — 4B.3 APROVADA NO ESCOPO | 4A, 4B.1, 4B.2 e 4B.3 comprovadas em `docs/evidence/ETAPA_4B3_AUTORIA_CENARIO_2026-08-18.md` e manifests hashados; commit técnico `aa9de017` | exportação, consumidores Godot/Unity, benchmark, 4B.4/4B.5 e merge ainda pendentes |
