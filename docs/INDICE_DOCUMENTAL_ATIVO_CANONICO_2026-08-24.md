...
| `evidence/CHG_POST_E13_HYBRID_3D_AUTHORING_20260911.md` | ATIVO / REGISTRO DE MUDANÇA EM IMPLEMENTAÇÃO | viewport híbrido 2D/2.5D/3D, cena vazia, câmera, meshes, luzes, gizmo e sidecar não destrutivo | decisão pós-E13, governança, REQ-F03/REQ-F04/REQ-F10/REQ-F02 e escopo 3D |
