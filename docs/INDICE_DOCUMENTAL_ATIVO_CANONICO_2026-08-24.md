...
| `evidence/AUDITORIA_POST_E13_PERFORMANCE_BASELINE_20260913.md` | ATIVO / AUDITORIA TÉCNICA — INVESTIGAÇÃO EVIDENCIADA; RESPONSIVIDADE EM ESCALA FAIL; MEMÓRIA/GPU PENDING_EVIDENCE | medição estrutural em escala, perfis causais, correções estreitas de viewport, build portátil r3 e evidência nativa do editor canônico 2D/3D/híbrido | governança, decisão O-2, decisão de continuidade pós-E13, commit `7f5c047` e build r3 |
| `evidence/EVD_POST_E13_PERFORMANCE_PENDENCIAS_20260913.md` | ATIVO / EVIDÊNCIA `IN_PROGRESS` | p95 residual de 249,28–398,73 ms em 512 objetos únicos, memória longa e GPU/janela nativa pendentes; decisões isoladas para o final | governança, auditoria de baseline, contrato O-2 e continuidade pós-E13 |
...
| `evidence/EVD_POST_E13_OFFICIAL_SUITE_R9_20260913.md` | ATIVO / EVIDÊNCIA CORRENTE `PASS` | suíte oficial completa r9: 2633 pass, 2 skips controlados, 0 warnings; JUnit/log/metadata hashados e failures históricos preservados | governança, guard de symlink, higiene, retry atômico, CuPy logging, tzdata e continuidade |
