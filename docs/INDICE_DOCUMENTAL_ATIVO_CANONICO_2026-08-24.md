...
| `evidence/AUDITORIA_POST_E13_PERFORMANCE_BASELINE_20260913.md` | ATIVO / AUDITORIA TÉCNICA — INVESTIGAÇÃO EVIDENCIADA; RESPONSIVIDADE EM ESCALA FAIL; MEMÓRIA PASS; GPU NOT_APPLICABLE | medição estrutural em escala, perfis causais, correções estreitas de viewport, build portátil r3, evidência nativa do editor canônico 2D/3D/híbrido e soak controlado de memória | governança, decisão O-2, decisão de continuidade pós-E13, commit `7f5c047` e build r3 |
| `evidence/EVD_POST_E13_PERFORMANCE_PENDENCIAS_20260913.md` | ATIVO / EVIDÊNCIA `IN_PROGRESS` | p95 residual de 249,28–398,73 ms em 512 objetos únicos, limite aceito formalmente, memória longa PASS no Docker, GPU/janela QGraphicsView NOT_APPLICABLE e Unity controlado BLOCKED | governança, auditoria de baseline, contrato O-2, decisão de soak e continuidade pós-E13 |
| `evidence/EVD_POST_E13_SOAK_MEMORIA_GPU_CONTROLADO_20260913.md` | ATIVO / EVIDÊNCIA `PASS` memória; `NOT_APPLICABLE` GPU | soak controlado de 26 workloads com 250 ciclos de memória por carga, RSS/private observados, zero erros/determinismo falso e ausência objetiva de contador GPU no caminho QGraphicsView | governança, decisão de soak, benchmark P2D-05 e commit `e727e9d` |
