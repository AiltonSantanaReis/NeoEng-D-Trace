...
| `evidence/EVD_POST_E13_OFFICIAL_SUITE_PRIVACY_FAILURE_20260913.md` | ATIVO / EVIDÊNCIA `FAIL` PRESERVADA | falha r5 de higiene por caminho absoluto no JUnit já versionado; raw hashado e correção de normalização registrados | governança, teste de higiene de referências e suíte oficial r5 |
