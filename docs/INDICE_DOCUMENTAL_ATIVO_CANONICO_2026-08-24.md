...
| `evidence/CHG_POST_E13_TILEMAP_PRO_AUTHORING_RUNTIME_20260912.md` | ATIVO / REGISTRO DE MUDANÇA EM IMPLEMENTAÇÃO | autoria profissional de Tilemap/Tileset, payload seguro e materialização em runtime externo | decisão pós-E13, governança e decisão de revisão humana |
...
| `evidence/EVD_POST_E13_TILEMAP_RUNTIME_ENGINES_20260912.md` | ATIVO / EVIDÊNCIA DE CHECKPOINT — PASS TÉCNICO | payload versionado, Godot/Unity reais, 27/27 células, drift de atlas rejeitado, build `c39a867` e fluxo Win32 do binário novo; lote pós-E13 continua aberto | CHG_POST_E13_TILEMAP_PRO_AUTHORING_RUNTIME_20260912.md, governança, decisão de continuidade e decisão de revisão humana |
| `evidence/CHG_POST_E13_HYBRID_3D_AUTHORING_20260911.md` | ATIVO / REGISTRO DE MUDANÇA — CHECKPOINT TÉCNICO PASS | viewport híbrido 2D/2.5D/3D, cena vazia, câmera, meshes, luzes, gizmo e sidecar não destrutivo; runtime externo permanece pendente | decisão pós-E13, governança, REQ-F03/REQ-F04/REQ-F10/REQ-F02 e escopo 3D |
...
| `evidence/AUDITORIA_FLUXO_USUARIO_POS_E13_FINAL_20260910.md` | ATIVO / AUDITORIA FINAL EM IMPLEMENTAÇÃO | matriz nativa final10, build, capturas, testes, limitações e decisões finais pós-E13 | governança, decisão de continuidade pós-E13, registros CHG-P13 e piloto Floresta |
