...
| `evidence/EVD_POST_E13_UNITY_CONTROLADO_SANDBOX_20260913.md` | ATIVO / EVIDÊNCIA `BLOCKED` | requalificações r9/r10 reais em Windows Sandbox: candidatos distintos foram copiados com SHA confirmado, Unity alcançou LicensingClient, encontrou zero entitlements aplicáveis e saiu com código 198; shutdown da sandbox comprovado, shutdown limpo do Unity ainda pendente; r1–r9 preservados | governança, decisão de soak, `sandbox-attempt.json` e resultados/logs sanitizados hashados, CHG de diagnósticos controlados |
