...
| `evidence/EVD_POST_E13_UNITY_CONTROLADO_SANDBOX_20260913.md` | ATIVO / EVIDÊNCIA `BLOCKED` | tentativa real autorizada em Windows Sandbox com fixture Unity mínima; launcher aceitou a configuração, mas VM preexistente impediu montagem/execução, sem Unity, licensing ou shutdown observados | governança, decisão de soak, `sandbox-attempt.json` hashado e CHG de diagnósticos controlados |
