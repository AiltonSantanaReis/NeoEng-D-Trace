...
| `evidence/EVD_POST_E13_UNITY_CONTROLADO_SANDBOX_20260913.md` | ATIVO / EVIDÊNCIA `BLOCKED` | requalificação r9 real em Windows Sandbox: licença autorizada foi copiada com SHA confirmado, Unity alcançou LicensingClient, encontrou zero entitlements aplicáveis e saiu com código 198; shutdown da sandbox comprovado, shutdown limpo do Unity ainda pendente; r1–r8 preservados | governança, decisão de soak, `sandbox-attempt.json` e resultado/log sanitizado hashados, CHG de diagnósticos controlados |
