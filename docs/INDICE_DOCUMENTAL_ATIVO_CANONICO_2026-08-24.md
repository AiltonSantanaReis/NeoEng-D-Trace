...
| `evidence/EVD_POST_E13_OFFICIAL_SUITE_R8_20260913.md` | ATIVO / EVIDÊNCIA CORRENTE `PASS` | suíte oficial completa r8: 2633 pass, 2 skips controlados, 0 warnings; JUnit/log hashados e failures históricos preservados | governança, guard de symlink, higiene, retry atômico, CuPy logging e tzdata |
...
| `evidence/CHG_POST_E13_CUPY_FALLBACK_LOG_20260913.md` | ATIVO / REGISTRO DE MUDANÇA `PASS` | ausência esperada do acelerador CuPy passa a INFO; falha anormal de driver continua WARNING e erro de processamento continua ERROR; build r5 e r8 comprovam os gates | governança, ADR CuPy, view_processor e suíte/build pós-E13 |
| `evidence/CHG_POST_E13_ATOMIC_REPLACE_RETRY_20260913.md` | ATIVO / REGISTRO DE MUDANÇA `PASS` | retry controlado para recusas transitórias do replace atômico do atlas, sem predelete e com rollback preservado; foco, repetição, r8 e build passaram | governança, finding WinError 5, testes atômicos e suíte oficial |
...
| `evidence/CHG_POST_E13_TZDATA_PACKAGING_20260913.md` | ATIVO / REGISTRO DE MUDANÇA `PASS` | dependência runtime pinada, contrato `ZoneInfo`, suíte r8 e build r5 com hook carregado e sem hidden import ausente | governança, `pyproject.toml`, `poetry.lock`, build portátil e smoke |
| `evidence/EVD_POST_E13_BUILD_CUPY_ATOMIC_20260913.md` | ATIVO / EVIDÊNCIA DE BUILD `PASS` | build portátil r5 limpa, executável/ZIP hashados, smoke 11/11, ciclo GUI real PT, CuPy opcional, retry atômico e tzdata qualificados | governança, mudanças CuPy/atlas/tzdata, provenance e suíte r8 |
