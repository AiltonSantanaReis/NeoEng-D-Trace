...
**Estado de execução:** A Etapa 1 foi encerrada após a PR #113 (`84dfee7`) e a PR documental #114 (`7e190b4`). A Etapa 2 está na PR #115; o primeiro CI registrou falha de isort, corrigida no commit `43733cb`, e aguarda nova execução remota. Sua decisão final permanece pendente dos gates próprios.
**Planos relacionados:**
