...
**Data:** 2026-09-04. **Estado:** `IN_PROGRESS / BLOCKED` para publicação.
...
O manifesto vivo será reconciliado com todos os arquivos rastreados aprovados
dos lotes P2D-05. Nenhum arquivo pode ser retirado do manifesto para obter PASS;
...
Pendente: qualificação completa do SHA corrigido, baseline/evidências finais,
runner Windows com cobertura, estática, segurança, Stage 4B.5, runner legado e
empacotamento. Logs novos serão preservados com comandos, ambiente, SHA,
estado da árvore, bytes e hashes, separando entrada, pré-commit e pós-commit.
