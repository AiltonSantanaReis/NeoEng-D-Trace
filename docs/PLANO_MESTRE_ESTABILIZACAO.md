...
- condições técnicas de `R-003` comprovadas; encerramento formal pendente de autorização explícita;
- Etapa 11 ainda não declarada concluída; release não aprovada.
