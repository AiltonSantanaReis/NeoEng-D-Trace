...
- quatro ZIPs sanitizados mediante autorização explícita, checksums internos e hashes externos recalculados; nova execução e inspeção continuam obrigatórias;
