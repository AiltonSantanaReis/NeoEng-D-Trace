...
- Worktree único: `<workspace>/build/e01-independent-scene-20260908`
- Branch única: `Ailton/e08-renderer-20260908`
- Escopo atual: estúdio integrado de cenários parallax, conforme
  `PLANO_POS_E13_ESTUDIO_PARALLAX_2026-09-09.md`. Preservar os ajustes de seleção
  contextual e múltipla, edição vetorial e tradução já realizados.
