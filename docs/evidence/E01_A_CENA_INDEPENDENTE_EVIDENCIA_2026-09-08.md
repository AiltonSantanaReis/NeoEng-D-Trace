...
**Estado do lote:** `IN_PROGRESS` — contrato, fluxo e captura nativa executados; aceite formal de E01-A ainda pendente dos critérios restantes de E01.
...
- Correção registrada em `a2070f65d2c5d3881fb9d781ec2bb4784d13dc53`; registro de continuidade e build em `f460cb93f1c6ecb5d95ea3afb9b4ecc1aee6484c`.
...
| Build portátil | `scripts/build_windows.ps1 -OutputRoot release\\e01-independent-scene-20260908-r4` | `PASS`, smoke com 11 checks |
| Executável | `release/e01-independent-scene-20260908-r4/portable/NeoEng-D-Trace/NeoEng-D-Trace.exe` | SHA-256 `C77EF0FE2BE69E85AACB74DB2AA083C710E47E71C302B7517FF95B33A7A900CE` |

## Captura real do binário

Capturador reproduzível: `scripts/capture_independent_scene_binary.ps1`.

Manifesto: `artifacts/e01-independent-scene-20260908/captures-r4/capture-manifest.json`.
