...
- `ETAPA_2_ICONES_DPI_2026-08-23.md` — matriz Qt 100/125/150/200%, galeria completa 16/20/24/32 px, hashes, clipping, auditoria visual e suíte local; PASS_LOCAL no commit `033278c`, aguardando PR/CI/pós-merge.
...
Plano vivo da modernização da interface: docs/PLANO_INTERFACE_MODERNA_PROFISSIONAL_2026-08-21.md. Este é o documento fonte de verdade somente para esse escopo de UI, subordinado às políticas globais. Etapas 0, 1, 3, 4 e 5: aprovadas nos escopos comprovados; Etapa 2: PASS_LOCAL, aguardando PR/CI/pós-merge; Etapas 6 e 7: parciais frente ao plano detalhado original; Etapas 8–14: planejadas. A reconciliação está em docs/evidence/RECONCILIACAO_PLANO_INTERFACE_ETAPAS_0_7_2026-08-22.md.
