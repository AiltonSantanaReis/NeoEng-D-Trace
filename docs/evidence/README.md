...
Plano vivo da modernização da interface: docs/PLANO_INTERFACE_MODERNA_PROFISSIONAL_2026-08-21.md. Este é o documento fonte de verdade somente para esse escopo de UI, subordinado às políticas globais. Etapas 0, 1, 3, 4 e 5: aprovadas nos escopos comprovados; Etapas 2, 6 e 7: parciais frente ao plano detalhado original; Etapas 8–14: planejadas. A reconciliação está em docs/evidence/RECONCILIACAO_PLANO_INTERFACE_ETAPAS_0_7_2026-08-22.md.
