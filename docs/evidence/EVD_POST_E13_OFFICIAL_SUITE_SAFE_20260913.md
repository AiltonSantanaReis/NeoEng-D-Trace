...
**Data:** 2026-09-13
**Checkout testado:** `72e60784d90030219a5300a4d6677726f5d0815e` mais as alterações de teste/documentação desta etapa
...
filesystem. A prova real desses dois casos está no sandbox Docker r3.
...
```text
.venv\Scripts\python.exe -m pytest -q --junitxml=artifacts/audit-post-e13-official-suite-safe-host-20260913-r3/official-junit.xml
```
...
```text
2626 passed, 2 skipped in 80.09s (0:01:20)
```
...
Os demais 2626 casos passaram, incluindo contratos de UI, persistência,
runtime, exportação, auditoria, limites operacionais e substituição atômica
GLTF.

## Artefatos e hashes

Pacote: `artifacts/audit-post-e13-official-suite-safe-host-20260913-r3/`

| Artefato | SHA-256 |
|---|---|
| `official-pytest.log` | `300CF0299F863EF3518191B089C23524D5FED517DA15803F3A66299B61979C33` |
| `official-junit.xml` | `7133498F9B043AA46DF88773AD7103ED375131A5D9D50142E5AF0CBA31FABDBB` |
...
transitória de `os.replace` no GLB; o teste isolado passou e a execução r3
completa passou. Nenhuma dessas falhas foi apagada ou reclassificada.
