...
Snapshot vivo de 11 de agosto de 2026. A Etapa 10 foi encerrada e a Etapa 11 está em andamento sobre a base `5e88c8d548e2b60612601f83e1bf24aeb91081bb`. Os Pacotes 1 a 3 somam `762` testes locais e elevaram a cobertura para 83,79% de linhas, 70,36% de branches e 80,55% combinada, sem módulos abaixo de 30%. Os CIs dos Pacotes 1 e 2, inclusive `31477232020`, foram aceitos após auditoria; o Pacote 3 ainda não possui CI; integração e CI pós-merge pendentes; release não aprovada.
...
| R-003 | ABERTO / EM TRATAMENTO | Pacotes 1 a 3 da Etapa 11: 762 testes locais, 83,79% de linhas, 70,36% de branches, 80,55% combinada e zero módulos abaixo de 30%; faltam ao menos 722 linhas e 543 branches para as metas finais 90%/85%; CIs dos Pacotes 1 e 2, inclusive `31477232020`, aceitos; Pacote 3 sem CI, integração e CI pós-merge pendentes |
