...
| R-022 | EM DESENVOLVIMENTO / NÃO APROVADO | Branch Ailton/runtime-stage7-streaming; contrato, carregamento assíncrono, prioridades, cache, descarte, recuperação e limites lógicos em implementação. Auditoria funcional local passou, mas source_tree_clean=false; faltam árvore limpa, evidências finais, CI, PR, merge e pós-merge |
