...
INTERMEDIATE_FAILURE_SUMMARY = (
    ...
    "as evidence.\n"
    "run=7 status=SUCCESS cause=Validator syntax, snapshot ordering, Unity "
    "semantic normalization, command sanitization, and engine-log separation "
    "were corrected; all closure gates passed.\n\n"
