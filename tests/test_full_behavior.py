...
try:
    ...
    from src.core.commands import CommandManager, AddPolygonCommand
...
class TestAppBehavior(unittest.TestCase):
    ...
    def test_01_command_undo_redo_flow(self):
        ...
        # Verifica adição
        self.assertEqual(len(self.scene.objects), 1, "Objeto deveria ter sido adicionado via comando")
    ...
    def test_03_export_pipeline_integrity(self):
        ...
        self.assertIsNotNone(found_sprite, "Objeto criado não apareceu na lista de sprites exportados")
